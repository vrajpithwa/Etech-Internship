...
const Header: React.FC = () => {
  ...
  const handleProjectsClick = () => {
    navigator('/projects'); // Navigate to the Projects page
  };
  const handleHomeClick = () => {
    navigator('/'); // Navigate to the Projects page
  };
  return (
    <AppBar
      position="absolute"
    ...
    >
      <Toolbar>
        ...
        <Button  onClick={handleProjectsClick} color="inherit">Projects</Button>
        <Box sx={{ ml: 2 }}>
